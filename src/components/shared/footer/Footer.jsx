...
const Footer = () => {
  ...
  const { message, error } = useSelector((state) => state.subscriber);
  ...
  }, [message, error, formRef]);

  return (
    <>
      <section className="bg-[#f1f5f96d]  dark:bg-[#182c494d] border-t dark:border-[#211d4c] ">
        <footer className="text-base xl:w-[1200px]    mx-auto footer pt-10 pb-12  px-3  m-auto  items-start justify-center md:justify-between ">
            ...
            <span className="z-10">
              <Link to={"/"} className="cursor-pointer ">
                ...
                <img
                  src={kinLogoLight}
                  alt=""
                  className=" h-[52px] w-fit dark:hidden  "
                />
              </Link>
            </span>
            ...
            <div className="text-[#3e5060] dark:text-[#b2bac2]">
              ...
              >
                <input
                  ...
                  className="py-3 z-10  rounded-md w-full px-3 bg-[#fff] border dark:bg-[#392f57d1] dark:border-[#848485]"
                />
                <input
                  type="submit"
                  value="Subscribe"
                  className="bg-[#d3e4f5] text-[#007fff] font-bold dark:bg-[#1e4976] z-10 py-2 px-3 rounded-md dark:text-white cursor-pointer"
                />
              </form>
            </div>
          </div>
          <div className=" py-8 md:py-0 text-[#3e5060] dark:text-[#b2bac2] flex flex-col  gap-2  items-center md:items-start mx-auto contact-section ">
            ...
            <a href="tel:+8801975467878" className="z-10">
            ...
            <a
              ...
              className="z-10 flex items-center gap-2 ml-1"
            >
              {/* <BsFillTelephoneFill className="w-6   h-6 inline-block mx-1 p-[3px]" /> */}
              <svg
            ...
            <a className="z-10" href={"mailto: kinsust03@gmail.com"}>
          ...
          <div className="text-[#3e5060] dark:text-[#b2bac2]  flex flex-col gap-[6px] items-center md:items-start mx-auto explore-section">
            ...
            <Link className="z-10" to={"/our-history"}>
              Our History
            </Link>
            <Link className="z-10" to={"/programs"}>
              Campaigns
            </Link>
            {/* <Link className="z-10" to={""}>
              Media
            </Link> */}
            <Link className="z-10" to={"/executive-committee"}>
              Executive Committee
            </Link>
            <Link to={"/faq"} className="z-10">
              FAQ
            </Link>
          </div>
        </footer>
        ...
        <div className="grid md:grid-cols-2 md:justify-items-between xl:w-[1200px] py-8 px-4  mx-auto text-[#3e5060] items-center dark:text-[#b2bac2]">
          ...
          <div className="social-icons order-1 md:order-2 flex pb-4 md:pb-0 gap-4  md:justify-end mx-auto md:mx-0 ">
            <a
              ...
              target="_blank"
              className="text-[#0077b5] z-10  dark:bg-[#6267d21e]  flex items-center h-12 rounded-full w-12  justify-center "
              rel="noreferrer"
            >
            ...
            <a
              ...
              rel="noreferrer"
              target="_blank"
              className=" z-10 text-[#0077b5]  dark:bg-[#6267d21e]  flex items-center h-12 rounded-full w-12  justify-center "
            >
