...
import {  updateUserPassword } from "../../features/auth/authApiSlice";
...
const Profile = () => {
  ...
  const handlePasswordChangeSubmit = async (e) => {
    ...
    dispatch(
      updateUserPassword({ password: inputs.password })
    );
  };
