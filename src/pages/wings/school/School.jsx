...
import school from "../../../assets/images/wings/school.jpg";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:image"
          content="https://react.kinsust.org/school.jpg"
        />

        <meta
          property="og:url"
          content="https://react.kinsust.org/kin-school"
        />
        <meta
        ...
        <meta
          property="og:title"
          content="Education is one of the basic necessities of human life, and it is
        ...
        <div className="xl:w-[1200px] mx-auto z-10 ">
          <div className="my-5 z-10 text-justify">
            <p className="my-5   z-10 ">
              ...
              the only weapon that holds the power of changing an entire nation.
              Unfortunately, some children are lagging behind in that race,
              either because they are not aware of its importance or they can
              {"'"}t bear the expenses the opportunity brings with it. In the
              year 2004, a group of young dreamers from Shahjalal University of
              Science & Technology (SUST) took the aim of spreading the light of
              education among the leftover, underprivileged children of the
              society, so that they can also have access to that opportunity. To
              fulfill that noble aim,{" "}
          ...
          <div className=" ">
            <h1 className="font-bold  dark:text-white mt-3 ">
              Our Activities:{" "}
            </h1>
            <div className="pl-9">
              <ul>
                <li className=" list-[square]">
                  <p>
                    ...
                    strongly believes that it is necessary for a child to stay
                    fit in order to get the best out of what they read. With
                    that view, other than their education, it also arranges
                    different health-related programs and health checkups, such
                    as free eye checkups for the children. On 28th June 2019,{" "}
                    <span className="font-bold dark:text-[#a1b1c6] text-[#1d1f1f]">
                      <span className="kin">KIN</span> School
                    </span>
                    , along with SICOPT, arranged a free dental camp for kids,
                    where dentists from {'"'}Shahjalal Microscopic and
                    Endodontic Center
                ...
                <li className="list-[square]">
                  <p>
                    ...
                    also provides warm clothes every year during the winter
                    season to underprivileged children in the society, ensuring
                    they experience the same warmth during cold days as other
                    children. Last year, on 19th December,{" "}
                    <span className="font-bold dark:text-[#a1b1c6] text-[#1d1f1f]">
                      <span className="kin">KIN</span> School
                    </span>{" "}
                ...
                <li className="list-[square]">
                  <p>
                    ...
                    aiming to collectively embrace the joy that EID brings to
                    our lives. In 2019,{" "}
                    <span className="font-bold dark:text-[#a1b1c6] text-[#1d1f1f]">
                      <span className="kin">KIN</span> School{" "}
                    </span>
            ...
            <p className="my-5">
              ...
              carries out its daily curricular activities from 4:00 pm to 5:00
              pm at Central Auditorium, SUST. The school{"'"}s workforce
              consists of young, altruistic SUST students who voluntarily
              contribute their efforts wholeheartedly for the children. You are
              warmly invited to dedicate an hour from your busy schedule to
              these innocent souls, helping them strengthen their belief in
              humanity and fostering a greater sense of connection with the more
            ...
            <div className="pl-9 mb-10">
              <ul>
                <li className=" list-[square]">
                  ...
                  activities for underprivileged children. It passionately
                  focuses on their mental, character, and moral development.
                </li>
                <li className="list-[square]">
                  The school provides study materials such as pens, pencils,
                  erasers, sharpeners, and extends monetary assistance to
                  students in need.
                </li>
              </ul>
            </div>
