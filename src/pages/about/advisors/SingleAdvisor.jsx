  ...
  return (
    <>
      <div className="text-center relative   dark:text-[#cdd6e2]  max-w-[330px] duration-700 h-full   ">
        <div className="flex flex-col justify-between  h-full cardDesign z-50    dark:bg-[#22174b72] dark:hover:bg-[#150f31b9] hover:bg-[#e2e3e647] bg-[#fdfdfd] dark:border-[#6250ad29] rounded-xl border-zinc-300 border-4 shadow-[0px_2px_5px_#eee] dark:shadow-none">
          <div>
            <PhotoProvider>
              <PhotoView src={photo}>
                <LazyLoadImage
                  alt={name}
                  src={photo}
                  className="rounded-2xl cursor-pointer py-2 mx-auto w-[270px] h-[270px]"
                  effect="blur"
                  width={"100%"}
            ...
            <div className="">
              <h1 className="md:text-2xl text-[20px] pb-3 pt-1 font-bold text-center ">
                {name}
              </h1>
