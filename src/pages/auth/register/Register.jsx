...
const Register = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Register to KIN </title>
        <meta name="description" content="For more information login to KIN." />
        ...
        <div className="dark:bg-[#182c49] dark:border-[#22174bcf] max-w-[450px] bg-[#eceff17e] mx-auto  py-5 px-4 sm:px-8 rounded-md border text-left shadow-xl">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="relative mb-8">
              <div className="form-input peer">
                <span className="flex justify-between gap-4">
                  <label className="dark:border-zinc-800 border-zinc-300 cursor-pointer flex-1 border py-2 text-center rounded-sm">
                    <input
                      type="radio"
                      onChange={handleChange}
                      value={"male"}
            ...
            <div className="mt-4 flex justify-center mb-6  text-zinc-500 dark:text-zinc-300">
              ...
              <Link
                to={"/login"}
                className="z-10 text-blue-600 hover:text-violet-600 px-2 "
              >
                {" "}
                LOGIN
              </Link>
