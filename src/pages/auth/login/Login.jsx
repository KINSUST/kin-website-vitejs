...
import { sendActiveCode, userLogin } from "../../../features/auth/authApiSlice";
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    dispatch(userLogin({ data: inputs, navigate }));
  };
          ...
          <form onSubmit={handleSubmit} className="dark:text-[#fff] z-10">
            ...
            <div className="my-5 z-10">
              <span className="text-sm flex justify-between">
                {!isRegister ? (
                  <Link
                    className="z-10 block text-[17px] text-red-400 hover:text-blue-600"
                    to={"/find-account"}
                  >
                    Forgot Password?
                  </Link>
